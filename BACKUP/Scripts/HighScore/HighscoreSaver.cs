...
public static class HighscoreSaver {
    ...
    private const string SECRET_KEY = "MySecretHashDude"; // Edit this value and make sure it's the same as the one stored on the server
    private const string ADD_SCORE_URL = "http://highscores.hostei.com/savehighscores.php?"; //be sure to add a ? to your url
    private const string GET_SCORE_URL = "http://highscores.hostei.com/gethighscores.php?";
    private const string SQL_SCORE_TABLE = "HighScores1";
